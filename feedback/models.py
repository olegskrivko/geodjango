...
class Feedback(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, help_text="Timestamp when the message was received.")
    updated_at = models.DateTimeField(auto_now=True, help_text="Timestamp when the message status was last updated.")
