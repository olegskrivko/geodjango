...
from .views import PetViewSet, PetSightingView,  PosterBulkCreateView,UserPostersAPIView, PetStatusCountsView, PosterDetailView,  get_user_pets, pet_post_quota, pet_view_stats, track_pet_share, flag_pet, unflag_pet, get_pet_flag_status  # get_pet_status_counts   # Import get_user_pets, PetSightingCreate, PetSightingHistoryViewSet,
from . import views
...
urlpatterns = [
    ...
    path('<int:pet_id>/view-stats/', pet_view_stats, name='pet-view-stats'),
    path('<int:pet_id>/track-share/', track_pet_share, name='track-pet-share'),
    path('<int:pet_id>/flag/', flag_pet, name='flag-pet'),
    path('<int:pet_id>/unflag/', unflag_pet, name='unflag-pet'),
    path('<int:pet_id>/flag-status/', get_pet_flag_status, name='get-pet-flag-status'),
